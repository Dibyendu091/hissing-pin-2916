        ...
        <div className={styles.container}>
                ...
                <div className={styles.sidebar_top}>
                    ...
                    <Link>
                        <div className={styles.top_child_3} style={{ width: '150%', display: 'flex', marginLeft: '-10px', }}>
                            <span>
                                <img style={{ width: '90%', margin: 'auto 0px' }} src="https://assets.bloomingdales.com/feature/header-bcom/latest/images/flags/IN.png" alt="" />
                            </span>
            ...
            <div className={styles.header_bottom}>
                <div className={styles.header_bottom_ch}>
                    <img src={Logo} style={{ width: '100%', height: '60px', paddingRight: '100px' }} alt="" />
                </div>
                <div style={{display:'flex'}} className={styles.header_bottom_ch}>
                    ...
                    {/* To Be Done */}
                    <i style={{margin:'10px 10px', border:'1px solid blue', color: 'red'}} className="fa-solid fa-bag-shopping"></i>
                    </div>
                </div>
            </div>
